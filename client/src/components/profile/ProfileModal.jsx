...
const ProfileModal = ({user, onClose, onSave, isAnEmployer}) => {
        ...
        return (
            <div className="mb-4 divide-y divide-black">
                ...
                {educationFields.map((item, index) => (
                    <div key={item.id} className="mb-4 px-4 pt-5 pb-4 sm:p-10 sm:pb-4">
                        <div className="mb-2">
                            ...
                            <input
                                ...
                                className="bg-neutral-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="text"
    ...
    const Form = () => {
        return (
            <form onSubmit={handleSubmit(onSubmit)} className="px-4 pt-5 pb-4 sm:p-10 sm:pb-4">
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <textarea
                        {...register("biography")}
                        className="bg-neutral-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline"
                        id="biography"
                    ></textarea>
    ...
    return (
        <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    className="inline-block align-bottom bg-slate-200 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                    <Form/>
                </div>
            </div>
        </div>
